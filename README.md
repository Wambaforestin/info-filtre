...
Identifier les informations légitimes/vérifiées pour aider à anticiper l'évolution du marché financer.
...
L'ensemble de votre projet et de vos résultats doit être regroupé sur un dépôt git à transmettre. Ce dépôt git peut être laissé en public ou bien partagé avec mon compte sur GitHub.
